        ...
        <div className="pt-24 pl-28 pr-28">
          ...
          >
            <h2 className="text-[var(--font-size-habibi-h2)] font-heading mb-4 text-center">
              Thérapies assistées par intelligence artificielle
            </h2>
            <div className="text-foreground/80 text-center mb-12 max-w-[800px] mx-auto">
              ...
              <p className="mb-4">
                Faire en sorte qu'ils soient dotées d'une expertise PLUS QUE SOLIDE pour être en mesure de t'accompagner aussi efficacement qu'un thérapeute, en utilisant des méthodes spécifiques !
              </p>
              <p>
                Celles-ci peuvent avoir accès à l'ensemble de tes informations et adapter leurs interventions à ta situation.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                "L'expert en motivation",
                "L'expert en thérapie des schémas",
                "L'expert en systémie",
                "L'expert en TCC",
              ].map((title, index) => (
                <div
                  key={index}
